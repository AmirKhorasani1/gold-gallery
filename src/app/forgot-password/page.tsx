...
const ForgotPassword = () => {
  return (
    <div dir="rtl" className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl overflow-hidden px-8 py-7">
        <h2 className="flex items-center gap-2 text-base font-semibold text-gray-800 mb-2">
          <span>←</span> بازنشانی رمز عبور
        </h2>
        ...
        <div className="mt-5">
          ...
          <Link href={"/login-register"}>
            <p className="text-center cursor-pointer gap-1 text-xs text-gray-700 font-semibold mt-4">بازگشت</p>
          </Link>
        </div>
      </div>
    </div>
